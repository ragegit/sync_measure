...
# Renart_measure(raster), my_measure
...
def main(N,Tmax):
	...
	# plot rasters--------------------------------------------------------------
	#plt.matshow(rasterSI,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Synchronous Irregular state")
	#plt.savefig('Simulations1/SI')
	#plt.matshow(rasterSR,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Synchronous Regular state")
	#plt.savefig('Simulations1/SR')
	#plt.matshow(smaller_step_rasterSR,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Synchronous Regular state with smaller time bin")
	#plt.savefig('Simulations1/small_bin_SR')
	#plt.matshow(smaller_step_noisy_rasterSR,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Smaller time bin - still SR?")
	#plt.savefig('Simulations1/noisy_SR')
	#plt.matshow(smaller_step_more_noisy_rasterSR,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("very noisy SR")
	#plt.savefig('Simulations1/very_noisy_SR')
	#plt.matshow(rasterAI,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Asynchronous Irregular state")
	#plt.savefig('Simulations1/AI')
	#plt.matshow(rasterAR,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Asynchronous Regular state")
	#plt.savefig('Simulations1/AR')
	#plt.matshow(Mixed5,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Mixed state")
	#plt.savefig('Simulations1/Mixed5')
	#plt.matshow(Mixed10,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Mixed state")
	#plt.savefig('Simulations1/Mixed10')
	#plt.matshow(Mixed20,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.title("Mixed state")
	#plt.ylabel("neuron number")
	#plt.savefig('Simulations1/Mixed20')
	#plt.matshow(rasterPo,cmap=cm.binary)
	#plt.xlabel("time bin")
	#plt.title("Poisson state")
	#plt.ylabel("neuron number")
	#plt.savefig('Simulations1/Poisson')
	#plt.show()
	...
	#plt.plot(np.where(rasterSR==1)[0],np.where(rasterSR==1)[1], '|')
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Synchronous Regular state")

	#a = fig.add_subplot(2,2,2)
	#plt.plot(np.where(rasterAR==1)[0],np.where(rasterAR==1)[1], '|')
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Asynchronous Regular state")

	#a = fig.add_subplot(2,2,3)
	#plt.plot(np.where(rasterSI==1)[0],np.where(rasterSI==1)[1], '|')
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Synchronous Irregular state")

	#a = fig.add_subplot(2,2,4)
	#plt.plot(np.where(rasterAI==1)[0],np.where(rasterAI==1)[1], '|')
	#plt.xlabel("time bin")
	#plt.ylabel("neuron number")
	#plt.title("Asynchronous Irregular state")
